...
const operationsDoc = `query listPlaylists @netlify(id: """33cf44c2-62ba-44a2-b74e-7fb93aba18f5""", doc: """List my playlists""") {
  spotify {
    me {
      displayName
      playlists {
...
exports.fetchListPlaylists = (variables, options) => {
  return fetchNetlifyGraph({
    query: operationsDoc,
    operationName: "listPlaylists",
    variables: variables,
    options: options || {},
  });
};

exports.fetchListPlaylistSongs = (variables, options) => {
  return fetchNetlifyGraph({
    query: operationsDoc,
    operationName: "listPlaylistSongs",
    variables: variables,
    options: options || {},
  });
};
...
const functions = {
   ...
   * List my playlists
   */
  fetchListPlaylists: exports.fetchListPlaylists,
  /**
   * An empty query to start from
   */
  fetchListPlaylistSongs: exports.fetchListPlaylistSongs,
};
